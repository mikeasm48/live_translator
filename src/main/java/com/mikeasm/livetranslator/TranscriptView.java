...
public interface TranscriptView {
    ...
    /**
     * Запись для расшифровки: что уехало в облако и что оттуда вернулось.
     * <p>
     * В окне этому места нет — там важен перевод, а не бухгалтерия. Но когда
     * на встрече случается странное, первый вопрос всегда один: отправляли мы
     * вообще что-нибудь или нет. Без записи на него нечем ответить.
     */
    default void note(String note) {}
}
